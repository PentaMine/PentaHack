...
public class ScaffoldDebugModule extends Module {
    ...
    public BooleanSetting display = new BooleanSetting("display block number", false);
    public BooleanSetting test = new BooleanSetting("test", false);


    public ScaffoldDebugModule() {
        super("ScaffoldDebug", Keyboard.KEY_NONE, Category.WORLD, "places blocks under the player");
    ...
    public boolean placeBlock(BlockPos pos, boolean swing, EventMotion event) {
        ...
        Client.addChatMessage("" + findBlockToPlaceOn(pos));
